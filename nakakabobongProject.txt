...
$(document).ready(function() {
    ...
    $("#login").click(function() {
        ...
        if(localStorage.getItem('pass') == null){
            ...
            currentPassword = JSON.parse(localStorage.getItem('pass'))
        }

        let inputUsername = $("#user").val();
        let inputPassword = $("#pass").val();

        if(inputUsername == currentUsername && inputPassword == currentPassword) {
            displayCurrentInfo();
            displayTotalCount();
            addToTable();
            $(".log-in-menu").hide();
    ...
    function displayCurrentInfo(){
        $("input[name = currentUsername]").val(currentUsername);
        $("input[name = currentPassword]").val(currentPassword);
    }
});